...
export default function AcceptPage(props) {
    ...
    const acceptAppointment = async selection => {
        ...
        const res = await axios.put(
            ...
            message.success("Termin erfolgreich angefragt");
            setButtonLoading(false)
            props.history.push(`/accept-match-feedback/${matchId}`)
        });
    };
        ...
        <Layout className="layout">
            <Content className="acceptPage" >
                <Row type="flex" justify="center" className="header" gutter={gutter}>
                    <Col sm={20} xs={24}>
                        <AngenommenIcon />
                        <h1>Fordern Sie jetzt den Kontakt zu dem Interessenten an.</h1>
                        <p className="subline">Sie zahlen nur bei erfolgreicher Kontaktaufnahme und haben so eine 100% Sicherheit.</p>
                    ...
                    <Col sm={12} xs={20} className="infoCard" type="flex" justify="center">
                        <Card loading={isLoading}>
                            ...
                            }
                            {
                                ...
                                <div className="checkmarks">
                                    <GreenCheckmark />
                                    Postleizahl: <span>&nbsp;{additionalInfo.zip}</span>
                                </div>
                            }
                            {
                                lead.industry &&
                            ...
                            <div className="confirm">
                                {match.leadPrice && <p className="price">{match.leadPrice}<sup><b>€</b></sup><sup><b> Netto</b></sup></p>}
                                ...
                                <Checkbox checked={consent} className="checkbox" onChange={e => setConsent(e.target.checked)}>
                                    <p>
                                    ...
                                    </a>&nbsp;und den <Link to="/nutzungsbedingungen">Nutzungsbedingungen</Link> von MySoftwareScout einverstanden.
                                </p>
                                </Checkbox>
